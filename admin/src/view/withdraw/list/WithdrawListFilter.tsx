...
import couponsEnumerators from 'src/modules/withdraw/withdrawEnumerators';
...
const schema = yup.object().shape({
  ...
  datewithdraw: yupFilterSchemas.dateRange(
    i18n('entities.withdraw.fields.datewithdraw'),
  ),
  ...
  type: yupFilterSchemas.enumerator(
    i18n('entities.withdraw.fields.type'),
  ),
});
...
const previewRenders = {
  ...
  datewithdraw: {
    label: i18n('entities.withdraw.fields.datewithdraw'),
  ...
  type: {
    ...
    render: filterRenders.enumerator(
      'entities.withdraw.enumerators.type',
    ),
  },
};
              ...
              <div className="row">
                ...
                <div className="col-lg-6 col-12">
                  <DatePickerRangeFormItem
                    name="datewithdraw"
                    label={i18n(
                      'entities.withdraw.fields.datewithdraw',
                    )}
                  />
                </div>
