...
import couponsEnumerators from 'src/modules/deposit/depositEnumerators';
...
const schema = yup.object().shape({
  ...
  datedeposit: yupFilterSchemas.dateRange(
    i18n('entities.deposit.fields.datedeposit'),
  ),
  ...
  type: yupFilterSchemas.enumerator(
    i18n('entities.deposit.fields.type'),
  ),
});
...
const previewRenders = {
  ...
  datedeposit: {
    label: i18n('entities.deposit.fields.datedeposit'),
  ...
  type: {
    ...
    render: filterRenders.enumerator(
      'entities.deposit.enumerators.type',
    ),
  },
};
              ...
              <div className="row">
                ...
                <div className="col-lg-6 col-12">
                  <DatePickerRangeFormItem
                    name="datedeposit"
                    label={i18n(
                      'entities.deposit.fields.datedeposit',
                    )}
                  />
                </div>
                ...
                {/* <div className="col-lg-6 col-12">
                  <SelectFormItem
                    name="type"
                    label={i18n(
                      'entities.deposit.fields.type',
                    )}
                    options={couponsEnumerators.type.map(
                      (value) => ({
                        value,
                        label: i18n(
                          `entities.deposit.enumerators.type.${value}`,
                        ),
                      }),
                    )}
                  />
