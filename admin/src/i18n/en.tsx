  ...
  entities: {
    ...
    deposit: {
      ...
      placeholders: {
        ...
        user: 'Select User',
        cryptoCurrency: 'Select Cryptocurrency',
        walletAddress: 'Enter Wallet Address',
        txid: 'Enter Transaction ID',
        network: 'Select Network',
        mobileProvider: 'Select Mobile Provider',
        phoneNumber: 'Enter Phone Number',
        depositId: 'Enter Deposit ID',
      },
      hints: {
        status: 'Current status of the deposit',
        amount: 'Amount being deposited',
        currency: 'Currency of the deposit',
        paymentMethod: 'Method used for the deposit',
        cryptoCurrency: 'Type of cryptocurrency',
        walletAddress: 'Destination wallet address for crypto',
        txid: 'Blockchain transaction ID (optional)',
        network: 'Blockchain network for crypto transfer',
        mobileProvider: 'Mobile money service provider',
        phoneNumber: 'Phone number used for mobile money',
        depositId: 'Reference number for mobile money deposit',
      },
      new: {
        title: 'New Deposit',
      },
    ...
    withdraw: {
      ...
      fields: {
        ...
        txid: 'Transaction ID',
        network: 'Network',
        // Mobile money withdrawal details
        mobileProvider: 'Mobile Provider',
        phoneNumber: 'Phone Number',
      ...
      placeholders: {
        ...
        user: 'Select User',
        cryptoCurrency: 'Select Cryptocurrency',
        walletAddress: 'Enter Destination Wallet Address',
        txid: 'Enter Transaction ID',
        network: 'Select Network',
        mobileProvider: 'Select Mobile Provider',
        phoneNumber: 'Enter Recipient Phone Number',
        withdrawId: 'Enter Withdrawal ID',
      },
      hints: {
        referenceNumber: 'Unique reference number for the withdrawal',
        status: 'Current status of the withdrawal',
        amount: 'Amount being withdrawn',
        currency: 'Currency of the withdrawal',
        paymentMethod: 'Method used for the withdrawal',
        cryptoCurrency: 'Type of cryptocurrency',
        walletAddress: 'Recipient wallet address for crypto withdrawal',
        txid: 'Blockchain transaction ID (optional)',
        network: 'Blockchain network for crypto transfer',
        mobileProvider: 'Mobile money service provider',
        phoneNumber: 'Recipient phone number for mobile money withdrawal',
        withdrawId: 'Reference number for mobile money withdrawal',
      },
      new: {
